class AppLink {
  ...
  static const String updateAppointment = "$_baseUrl/bookings/";
  static const String deleteAppointment = "$_baseUrl/bookings/";
  static const String getAllPrescriptions = "$_baseUrl/prescriptions/";
