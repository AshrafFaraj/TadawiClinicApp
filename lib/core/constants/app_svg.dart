class AppSvg {
  ...
  static const String send = "${path}send-2-svgrepo-com.svg";
  static const String appointmentOutlined =
      "${path}calendar-svgrepo-com (1).svg";
  static const String appointmentFilled = "${path}calender-svgrepo-com.svg";
  static const String profile = "${path}profile-round-1346-svgrepo-com.svg";
  static const String home = "${path}home-2-svgrepo-com.svg";
